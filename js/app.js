...
const productIntShoppingCart = document.querySelector('.products-in-cart');
...
function addToCart(){
    ...
    productIntShoppingCart.innerHTML = productHTMLElement
...
function onBtnDeleteClick(){
    ...
    if(productsInCart == 0){
        productIntShoppingCart.innerHTML= '';
    }
}
